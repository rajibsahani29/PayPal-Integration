...
Partial Class main
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                If objFunction.CheckDataSet(dstClient) Then
                    ...
                    Session("ClientFullName") = objFunction.ReturnString(dstClient.Tables(0).Rows(0)("ClientFullName"))
                    Session("ClientEmailId") = objFunction.ReturnString(dstClient.Tables(0).Rows(0)("emailx"))
    ...
    Protected Sub BUT_Logout_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BUT_Logout.Click
        Try
            ...
            Session("ClientFullName") = Nothing
            Session("ClientEmailId") = Nothing
    ...
    Protected Sub BUT_resend_verification_Click(sender As Object, e As System.EventArgs) Handles BUT_resend_verification.Click
        Try
            ...
            If objFunction.CheckDataSet(dstData) Then
                ...
                Dim strEmailContent As String = objEmailContent.RegistrationVerification(objFunction.ReturnString(dstData.Tables(0).Rows(0)("name1")), strVerificationLink, "sss/sss", objFunction.ReturnString(dstData.Tables(0).Rows(0)("email_signature")))
